...
First of all insatall our [Dev Container Extension for VSCode](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-containers).
...
Click on "Reopen in Container," and you'll now be working inside the container.
...
Now, for the final step before running our server. 
