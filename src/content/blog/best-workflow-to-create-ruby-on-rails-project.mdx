...
Let's start with creating new very simple, minimalistic project:

```bash
rails new [my-project] -c tailwind -d postgresql --skip-jbuilder -T --skip-action-mailbox -a propshaft
```
